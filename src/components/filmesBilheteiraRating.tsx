...
import {filmesBilheteiraID} from '../pages/homePage';
...
function VerRatingsBilheteira(){
    ...
    return(
        <IonPage id="view-Recomendados-BoxOffice-page">
            ...
            <IonTitle className="alignTitle">Filmes Bilheteira - Box Office</IonTitle>
...
export default VerRatingsBilheteira;